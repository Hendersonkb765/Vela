    ...
    return (
        <>
            <div
                ...
                className="w-full sm:h-40 relative lg:w-80 min-w-[328px] fullhd:w-96 sm:rounded-xl bg-white dark:bg-slate-800 flex flex-col items-start justify-start px-6 py-4 space-y-4 text-white cursor-pointer lg:hover:scale-110 transition group overflow-hidden rounded-lg"
            >
                <div>
