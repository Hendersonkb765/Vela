...
const HelpMe = () => {
    ...
    return (
        <div className='fixed z-50 bottom-24 lg:bottom-8 right-4 md:right-8 flex items-center justify-center'>
            <div className='group flex items-center space-x-2'>
                ...
                <div
                    className='bg-slate-700 dark:bg-slate-600 cursor-pointer p-2 rounded-full group-hover:scale-110'
                    onClick={handleOpenModal}
                >
                    {/* <GoCopilot className='w-9 h-9 dark:text-gray-100' /> */}
                    <IoMdHelp className='w-9 h-9 text-gray-100'/>
                </div>
            </div>
