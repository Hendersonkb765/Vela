    ...
    return (
        ...
        >
            ...
            <div className="flex p-5 gap-5 flex-wrap justify-center sm:justify-start">
                ...
                {/* <div className="sm:w-80 sm:h-80 w-full h-72 p-4 hover:scale-[1.05] transition-transform duration-300 dark:bg-slate-800 bg-white rounded-2xl flex flex-col justify-between items-center" >
                ...
                <div className="sm:w-80 sm:h-80 w-full h-72 relative p-4 hover:scale-[1.05] transition-transform duration-300 dark:bg-slate-800 bg-white rounded-2xl flex flex-col justify-center items-center" >
