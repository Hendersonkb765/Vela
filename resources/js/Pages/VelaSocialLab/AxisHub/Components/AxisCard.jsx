    ...
    return(
        ...
        <div className="relative">
            ...
            {blocked &&(
                ...
                <GoLock strokeWidth="1.5" className="text-5xl text-neutral-400 dark:text-slate-400"/>
                <p className="text-neutral-400 dark:text-slate-400 font-semibold">Em Breve</p>
            ...
            <div className={blockedStyle + ' sm:w-80 sm:h-96 h-96 w-full  p-4 relative hover:scale-[1.05] transition-transform duration-300 dark:bg-slate-800 bg-white rounded-2xl flex flex-col justify-between items-center'}>
