...
export default function Settings({ auth, mustVerifyEmail, status,storageDrive }) {
    ...
    return (
        ...
        >
            ...
            <section className="mx-auto px-4 gap-9 mt-10 mb-16 lg:mb-0 lg:mt-0 w-screen sm:w-full pb-8 overflow-y-auto items-start flex flex-col-reverse lg:flex-row lg:justify-start lg:space-x-12 lg:py-8 lg:pb-0 ">
                ...
                <aside className='w-full h-40 flex-col items-center space-y-4 m lg:w-fit mb-16 xl:mb-0 lg:ml-auto pt-8 lg:pt-0  '>
                    <div >
