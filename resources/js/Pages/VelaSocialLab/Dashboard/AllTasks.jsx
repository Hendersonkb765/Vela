...
const AllTasks = ({tasks}) => {
    return (
        <Link className='w-full sm:w-72 h-52 min-w-fit bg-white p-4 overflow-hidden relative group cursor-pointer dark:bg-slate-800' href={route('taskhub')}>
            ...
            <div rounded className='w-16 h-16 text-primary absolute -bottom-2 -right-3 flex justify-center items-center rounded-full border-2 border-primary group-hover:bg-primary group-hover:text-white transition-all delay-150 group-hover:scale-150'>
